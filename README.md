#Puppet Blueprint: linux_box

##Description

A Puppet Blueprint for a Linux (base) box/host.
...
####Clone the linux_box Chef Blueprint
	...
	$ mkdir -p ~/src/github/puppet-blueprints
	$ cd ~/src/github/puppet-blueprints
	$ git clone https://github.com/puppet-blueprints/linux_box.git
	$ cd linux_box

Or alternatively, download and extract the zip https://github.com/puppet-blueprints/linux_box/archive/master.zip
